...
float pid_d_gain_roll = 23.0;              //Gain setting for the roll D-controller
...
float pid_p_gain_yaw = 3.6;                //Gain setting for the pitch P-controller. //4.0
...
if(abs(acc_x) < acc_total_vector){
  ...
  pid_roll_setpoint /= 3.5;                                                 //Divide the setpoint for the PID roll controller by 3 to get angles in degrees.
  ...
  pid_pitch_setpoint /= 3.5;                                                 //Divide the setpoint for the PID pitch controller by 3 to get angles in degrees.
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    if (esc_2 < 1100) esc_2 = 1100;                                         //Keep the motors running.static 
